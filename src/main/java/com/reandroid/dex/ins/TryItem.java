...
public class TryItem extends DexContainerItem implements Iterable<TryHandler>{
    ...
    @Override
    public Iterator<TryHandler> iterator(){
        return tryHandlerList.iterator();
    }
    public int getStartAddress(){
        return handlerOffsetArray.getStartAddress(getIndex());
    }
    public int getCatchCodeUnit(){
        return handlerOffsetArray.getCatchCodeUnit(getIndex());
    }
